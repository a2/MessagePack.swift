...
class MessagePackSpec: QuickSpec {
    override func spec() {
        describe("example") {
            ...
            it("packs correctly") {
                expect(pack(example)).to(beContainedIn(correct, ==))
            }
        ...
        describe("double") {
            ...
            let packed: [UInt8] = [0xcb, 0x40, 0x09, 0x1e, 0xb8, 0x51, 0xeb, 0x85, 0x1f]
        ...
        describe("float") {
            ...
            let packed: [UInt8] = [0xca, 0x40, 0x48, 0xf5, 0xc3]
        ...
        describe("string") {
            ...
            let packed: [UInt8] = [0xad, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x2c, 0x20, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x21]
        ...
        describe("binary") {
            let value = MessagePackValue.Binary([0x00, 0x01, 0x02, 0x03, 0x04])
            let packed: [UInt8] = [0xc4, 0x05, 0x00, 0x01, 0x02, 0x03, 0x04]
        ...
        describe("array") {
            ...
            let packed: [UInt8] = [0x95, 0x00, 0x01, 0x02, 0x03, 0x04]
        ...
        describe("map") {
            ...
            let packed: [UInt8] = [0x81, 0xa1, 0x63, 0xa6, 0x63, 0x6f, 0x6f, 0x6b, 0x69, 0x65]
        ...
        describe("extended") {
            context("fixext 1") {
                let value = MessagePackValue.Extended(type: 5, data: [0x00])
                let packed: [UInt8] = [0xd4, 0x05, 0x00]
            ...
            context("fixext 2") {
                let value = MessagePackValue.Extended(type: 5, data: [0x00, 0x01])
                let packed: [UInt8] = [0xd5, 0x05, 0x00, 0x01]
            ...
            context("fixext 4") {
                let value = MessagePackValue.Extended(type: 5, data: [0x00, 0x01, 0x02, 0x03])
                let packed: [UInt8] = [0xd6, 0x05, 0x00, 0x01, 0x02, 0x03]
            ...
            context("fixext 8") {
                let value = MessagePackValue.Extended(type: 5, data: [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07])
                let packed: [UInt8] = [0xd7, 0x05, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07]
            ...
            context("fixext 16") {
                let value = MessagePackValue.Extended(type: 5, data: [0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f])
                let packed: [UInt8] = [0xd8, 0x05, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f]
            ...
            context("ext 8") {
                ...
                let value = MessagePackValue.Extended(type: 5, data: payload)
                let packed: [UInt8] = [0xc7, 0x07, 0x05] + payload
            ...
            context("ext 16") {
                ...
                let value = MessagePackValue.Extended(type: 5, data: payload)
                let packed: [UInt8] = [0xc8, 0x01, 0x00, 0x05] + payload
            ...
            context("ext 32") {
                ...
                let value = MessagePackValue.Extended(type: 5, data: payload)
                let packed: [UInt8] = [0xc9, 0x00, 0x01, 0x00, 0x00, 0x05] + payload
